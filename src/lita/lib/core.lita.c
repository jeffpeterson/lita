...
static Chunk chunk_dump_3() {
  ...
  c.capacity = 25;
  u8 code[] = {
    0, 0, 14, 0, 44, 1, 33, 1, 0, 2, 33, 1, 14, 0, 44, 3, 33, 1, 0, 4, 33, 1, 40, 1, 40,
  };
  int lines[] = {
...
static Chunk chunk_dump_global_4() {
  ...
  c.capacity = 47;
  u8 code[] = {
    0, 0, 7, 0, 1, 14, 0, 44, 2, 33, 1, 0, 0, 33, 1, 7, 0, 3, 14, 0, 44, 4, 33, 1, 0, 5, 33, 1, 7, 0, 6, 7, 0, 7, 7, 0, 8, 0, 9, 33, 1, 7, 0, 10, 7, 1, 40,
  };
  int lines[] = {
    17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 25, 25,
  };
  c.code = cloneMemory(code, sizeof(code));
  c.lines = cloneMemory(lines, sizeof(lines));
...
static Chunk chunk_dump_8() {
  ...
  c.capacity = 15;
  u8 code[] = {
    0, 0, 14, 0, 44, 1, 33, 1, 0, 2, 33, 1, 40, 1, 40,
  };
  int lines[] = {
